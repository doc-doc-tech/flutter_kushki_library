class KushkiResponse {
  ...
  factory KushkiResponse.fromMap(Map<String, dynamic> map) {
    ...
    final code = incominCode == 'SUCCESS'
        ? KushkiReponceCode.SUCCESS
        : KushkiReponceCode.ERROR;
    return KushkiResponse(code, map['token'], map['message']);
  }
}

enum KushkiReponceCode { SUCCESS, ERROR }
